...
# ckpt = torch.load('/home/haibo/workspace/Videogen/experiments/image_epoch_1.pth', map_location='cpu')
# print(ckpt)
# ckpt = torch.load('/home/haibo/workspace/Videogen/experiments/video_epoch_5_iteration_16064_motion_modules_stride_8.pth', map_location='cpu')
# lora_ckpt = {k: v for k, v in ckpt.items() if 'motion' in k}
# torch.save(lora_ckpt, '/home/haibo/workspace/Videogen/experiments/video_epoch_5_iteration_16064_motion_modules_stride_8.pth')
...
style_path = [
    '/home/haibo/workspace/AnimateDiff/Realistic_Vision_V5.1_noVAE', 
    '/home/haibo/workspace/AnimateDiff/toonyou_beta6', 
    '/home/haibo/workspace/AnimateDiff/epiCRealism',
    '/home/haibo/workspace/AnimateDiff/ResidentCNZCartoon3D',
    ][0]
